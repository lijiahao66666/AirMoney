...
server.listen(port, () => {
  console.log(`[AirMoney API Server] listening on port ${port}`);
  console.log(`[AirMoney API Server] GET  http://localhost:${port}/config`);
  console.log(`[AirMoney API Server] POST http://localhost:${port}/ (API proxy)`);
});
